/*
 * CATÁLOGO ESCALABLE DE IMÁGENES RTE
...
export const EQUIPMENT_IMAGE_CATALOG={
  ...
  controllers:{
    ...
    items:[
      ...
      {label:"DualShock 3",file:"dualshock-3.png",terms:["dualshock 3","control ps3","mando ps3","control playstation 3"]},
      ...
      {label:"Control Xbox 360",file:"control-xbox-360.png",terms:["control xbox 360","mando xbox 360","controller xbox 360","xbox 360"]},
...
export async function addEquipmentReferenceInline(pdf,equipo,modelo,x,y,w,h,dark=true){
  ...
  pdf.setDrawColor(220,24,35);pdf.setLineWidth(.45);pdf.roundedRect(x,y,w,h,2,2,"FD");
  ...
  pdf.setTextColor(...(dark?[255,155,162]:[150,10,20]));pdf.setFont("helvetica","bold");pdf.setFontSize(4.4);
